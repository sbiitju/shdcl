package com.shahinbashar.qsandroid.core.domain.error


import com.google.gson.Gson
import com.shahinbashar.qsandroid.core.data.BadRequestErrorDto
import com.shahinbashar.qsandroid.core.data.ErrorDto
...
//        code() == 400 -> ExceptionModel.Http.BadRequest
        code() == 401 -> ExceptionModel.Http.Custom(
            code(),
            message(),
            "You are not verified user, ask your hall super to get approved"
        )
...
//        code() in 500..600 -> ExceptionModel.Http.ServerException
            ...
            code(),
            message(),
            convertToErrorDto(errorBody())?.messages?.firstOrNull()
        )
    }
}
