...
import com.shdclgroup.app.features.login.view.LoginNewEvent
import com.shdclgroup.app.features.login.view.LoginNewViewModel
import com.shdclgroup.app.features.login.view.LoginNewViewState
...
fun NewLogin(
    ...
    Column(
        ...
        Text(
            text = "Version: ${com.shdclgroup.app.BuildConfig.VERSION_NAME} (${com.shdclgroup.app.BuildConfig.VERSION_CODE})",
